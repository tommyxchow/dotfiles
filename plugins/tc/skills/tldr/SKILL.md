...
Voice matches global Communication. Stay human. One idea per sentence. Prefer under 25 words. Same word for the same thing. Gloss a term on first use. Don't flatten a guess into a fact. Don't lead with a table. Add a table or simple diagram only to compare 3+ items or show a layout. Skip it if a short list is enough. Don't recap at the end.
