...
- **Quality only — not bugs.** If any lens finds a correctness defect, return its concrete failure scenario as a review finding for `tdd`. Do not apply its fix as behavior-preserving cleanup.
