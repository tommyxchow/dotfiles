...
- When I say we good, anything outstanding, pass, quick pass, do a pass, final pass, final review, final double check, or close this out: follow the `pass` skill. That is not polish, not a code review, and not permission to commit.
