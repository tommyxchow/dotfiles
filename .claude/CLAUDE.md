...
- Teach in passing: the one non-obvious why when it would change how I use or trust the result. Go under the hood only for a tradeoff that needs my call or when I asked how something works. Don't turn the task into a lesson, and skip the plumbing and boilerplate.
