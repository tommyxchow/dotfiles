...
- **Subagents are yours to spawn when they make the result better or faster**: parallel research, a fresh-context review, a big mechanical loop, page fetches kept out of this window. Not for a small task or a small change, where a cold start costs more than it saves. Inside a skill, its own size gate decides.
