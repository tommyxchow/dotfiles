...
- A skill written as step-by-step scaffolding for an older model. Newer models often do worse with enumerated steps than with the goal and constraints; try the skill with the scaffolding removed before keeping it.
